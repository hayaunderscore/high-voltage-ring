...
namespace FastColoredTextBoxNS
{
    public class SyntaxHighlighter : IDisposable
    {
        ...
        protected Regex ACSCommentRegex1, ACSCommentRegex2, ACSCommentRegex3, ACSCommentRegex4, ACSKeywordRegex, ACSNumberRegex, ACSStringRegex, ACSFunctionsRegex;
        ...
        protected void InitACSRegex()
        {
            ...
            ACSCommentRegex1 = new Regex(@"//.*$", RegexOptions.Multiline | RegexCompiledOption);
            ACSCommentRegex2 = new Regex(@"(/\*.*?\*/)|(/\*.*)", RegexOptions.Singleline | RegexCompiledOption);
            ACSCommentRegex3 = new Regex(@"(/\*.*?\*/)|(.*\*/)",
                                            RegexOptions.Singleline | RegexOptions.RightToLeft | RegexCompiledOption);
            ACSCommentRegex4 = new Regex(@"#.*$", RegexOptions.Multiline | RegexCompiledOption);
            ACSNumberRegex = new Regex(@"\b\d+[\.]?\d*([eE]\-?\d+)?[lLdDfF]?\b|\b0x[a-fA-F\d]+\b",
                                          RegexCompiledOption);
            ACSKeywordRegex =
                new Regex(
        ...
        public virtual void ACSSyntaxHighlight(Range range)
        {
...
";
            ...
            range.ClearStyle(StringStyle, CommentStyle, CommentTagStyle, NumberStyle, KeywordStyle, FunctionsStyle);
            //
            if (ACSStringRegex == null)
                InitACSRegex();
            //string highlighting
            range.SetStyle(StringStyle, ACSStringRegex);
            //comment highlighting
            range.SetStyle(CommentStyle, ACSCommentRegex1);
            range.SetStyle(CommentStyle, ACSCommentRegex2);
            range.SetStyle(CommentStyle, ACSCommentRegex3);
            range.SetStyle(CommentTagStyle, ACSCommentRegex4);
            //number highlighting
            range.SetStyle(NumberStyle, ACSNumberRegex);
            //keyword highlighting
            range.SetStyle(KeywordStyle, ACSKeywordRegex);
            //function highlighting
            range.SetStyle(FunctionsStyle, ACSFunctionsRegex);
